...
async def cmd_start(message: types.Message):
    await message.answer(
        ...
        "📌 Как я работаю:\n"
        "• Если бюджет совпадет с оптимальной стоимостью моих готовых решений под сборку — предложу готовое решение\n"
        "• Если Вы хотите собрать компьютер на предложенную Вами стоимость(менее 50 000 руб, ровно 100, 150 тыс. руб. и др.)— свяжу вас со мной лично\n\n"
